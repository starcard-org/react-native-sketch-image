...
public class SketchImageEditorManager extends SimpleViewManager<SketchImageEditor> {
    ...
    public static SketchImageEditor Canvas = null;
    ...
    public String getName() {
        return "RNSketchImageEditor";
    }

    @Override
    protected SketchImageEditor createViewInstance(ThemedReactContext context) {
        SketchImageEditorManager.Canvas = new SketchImageEditor(context);
        return SketchImageEditorManager.Canvas;
    }

    @ReactProp(name = PROPS_SHAPE_CONFIGURATION)
    public void setShapeConfiguration(SketchImageEditor viewContainer, ReadableMap shapeConfiguration) {
    ...
    public void setLocalSourceImage(SketchImageEditor viewContainer, ReadableMap localSourceImage) {
    ...
    public void setText(SketchImageEditor viewContainer, ReadableArray text) {
    ...
    @Override
    protected void addEventEmitters(ThemedReactContext reactContext, SketchImageEditor view) {

    }

    @Override
    public void receiveCommand(SketchImageEditor view, int commandType, @Nullable ReadableArray args) {
        switch (commandType) {
